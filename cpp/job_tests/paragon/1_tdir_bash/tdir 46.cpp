...
int main() {
	try {
		enum struct argumentCount : int {empty, tdir_exit, tdir_path, tdir_path_rkey, redundant};	// Acceptable number of arguments: 1) tdir, 2) tdir path/mask, 3) tdir path/mask -r.
