...
//*********************************************************************************************************************************************************
bool retrieveMaskSTL(const char* const path, const char* mask) {
//	using std::string;
...
//	const char rightSlash = '/';	// Linux directory separator.
//	const char leftSlash = '\\';	// Windows directory separator. //TO DO: Check a right slash in Windows.
//	QString pathStr(path);			// Construct a path string to manipulate with.
//	QString maskStr{};
