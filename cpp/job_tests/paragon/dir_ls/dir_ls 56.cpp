...
//#elif windows //TO DO: Correct it under in Windows Qt.
...
//#endif
	...
	int slashPos = path.lastIndexOf(rightSlash, wildcardPos);	// Find the position of the a slash before the first wildcard.
